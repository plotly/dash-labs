...
x_component = iris.inputs["x"].value
y_component = iris.inputs["y"].value
...
x_container = iris.inputs["x"].container
y_container = iris.inputs["y"].container
output_container = iris.output[0].container

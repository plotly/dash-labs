...
from dash_express.templates.base import ParameterPlugin


class FilterTable(ParameterPlugin):
    def __init__(self, df, px_kwargs=None, page_size=5, serverside=False, template=None):
    ...
    def _compute_props(self, template):
        ...
        self._output = [
            (template.Graph(id=self.graph_id), "figure"),
            (template.DataTable(
